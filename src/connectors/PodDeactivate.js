...
function _initialize(podId) {
    request.open("DELETE", devServer + endpointPath + podId, false);
    // request.open("DELETE", prodServer + endpointPath, false);
...
function __execute() {
    if (request.status >= 400) {
        ...
        result.message = "Successfully deactivated pod.";
    }
}
